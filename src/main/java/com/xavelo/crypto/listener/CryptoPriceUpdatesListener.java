...
public class CryptoPriceUpdatesListener {
    ...
    private void checkDocument() {
        ...
        List<PriceDocument> recentDocuments = repository.findByTimestampAfter(oneMinuteAgo);
        logger.info("Found {} documents inserted in the last minute", recentDocuments.size());
    }
